...
#SBATCH --output=./s%j_job.pipeline_test_1sample.out
#SBATCH --error=./s%j_job.pipeline_test_1sample.error
...
#nextflow main.nf --outdir ${out_dir} --fastqdir ${fqdir} --samplesheet ${samplesheet} --skip_porechop -resume
nextflow main.nf --outdir ${out_dir} --fastqdir ${fqdir} --samplesheet ${samplesheet} --skip_download_centrifuge_db
